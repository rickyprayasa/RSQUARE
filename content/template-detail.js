    ...
    try {
        ...
        if (product) {
            ...
            const tombolBeliManualHTML = `
                <a href="${linkBeliManual}" class="btn-primary inline-block items-center justify-center w-full px-8 py-3 rounded-lg font-semibold" onclick="fbq('track', 'InitiateCheckout');">
