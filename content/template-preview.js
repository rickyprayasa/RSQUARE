    ...
    try {
        ...
        if (product && product.detail && product.detail.galeri) {
            ...
            const tombolBeliLangsungHTML = `
                <a href="${linkBeliLangsung}" class="btn-primary inline-block flex items-center justify-center w-full px-8 py-3 rounded-lg font-semibold" onclick="fbq('track', 'InitiateCheckout');">
