document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        // Path ini mengasumsikan file preview.html ada di dalam folder /templates/preview/
        ...
        // Perubahan: Kita sekarang memeriksa 'product.detail.galeri'
        if (product && product.detail && product.detail.galeri) {
            ...
            // Perubahan: Menggunakan deskripsi lengkap sebagai meta description
            ...
            // Perubahan: Looping dari 'product.detail.galeri'
            ...
            // Perubahan: Mengambil link dari 'product.detail.link_youtube'
            const videoHTML = `
            ...
            const ctaHTML = `
                <section class="container mx-auto mt-12 text-center">
                    ...
                    <div class="mt-8 flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-8">
                        <a href="../${product.id}.html" class="text-gray-500 hover:text-orange-600 font-semibold transition">← Kembali ke Ringkasan</a>
            ...
            // Jika produk tidak ditemukan di JSON atau tidak punya data galeri
            container.innerHTML = `
                <div class="container mx-auto text-center py-40">
        ...
        container.innerHTML = `
            <div class="container mx-auto text-center py-40">
                ...
                <p class="text-gray-600 mt-2">Tidak dapat memuat data produk. Silakan coba muat ulang halaman atau hubungi kami.</p>
            </div>`;
    }
});